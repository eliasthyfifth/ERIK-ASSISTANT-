...
```
OR add the shortcut from setting>keyboard and set the command as :
```bash
/path/to/ERIK/venv/bin/python /path/to/ERIK/erik_client.py "your message"
```
When you perform the shortcut an pop up will appear in which you can type your message
